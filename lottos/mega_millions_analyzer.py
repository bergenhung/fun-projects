...
try:
    ...
    print("Install with: pip install requests pandas numpy matplotlib")
    sys.exit(1)
...
def generate_pick(stats: dict) -> tuple:
    """Generate one 5+1 set using historical probability weights."""
    main = sorted(weighted_pick(stats["pool_prob"], 5))
    mb   = weighted_pick(stats["mb_prob"], 1)[0]
    return main, mb
